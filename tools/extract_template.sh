...
xgettext *.php */*.php --copyright-holder='Mreporting Development Team' --package-name='GLPI - Mreporting plugin' --package-version='1.5.0' -o locales/mreporting.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
