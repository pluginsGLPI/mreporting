...
if (!is_readable(GLPI_ROOT . "/plugins/racks/locales/".$_GET['lang'].".php")) {
   print "Unable to read dictionnary file\n";
   exit();
}
include (GLPI_ROOT . "/plugins/racks/locales/en_GB.php");
$REFLANG = $LANG;

$lf     = fopen(GLPI_ROOT . "/plugins/racks/locales/".$_GET['lang'].".php", "r");
$lf_new = fopen(GLPI_ROOT . "/plugins/racks/locales/temp.php", "w+");
...
include (GLPI_ROOT . "/plugins/racks/locales/temp.php");

if (!is_readable(GLPI_ROOT . "/plugins/racks/locales/glpi.pot")) {
   print "Unable to read glpi.pot file\n";
   exit();
}
$current_string_plural = '';

$pot = fopen(GLPI_ROOT . "/plugins/racks/locales/glpi.pot", "r");
$po  = fopen(GLPI_ROOT . "/plugins/racks/locales/".$_GET['lang'].".po", "w+");
